...
export default function (state = initialState, action) {
    switch (action.type) {
        ...
        case types.SELECT_ROW:
            ...
            var newItems = Array.concat([], state.items);
            if (action.selectRow.parentKey) {
                var parentIndex = newItems.findIndex(x => { return x.key == action.selectRow.parentKey });
                var parent = newItems[parentIndex];
                var targetItemIndex = parent.version.findIndex(x => { return x == action.selectRow });
                parent.version[targetItemIndex].isSelected = !parent.version[targetItemIndex].isSelected ? true : false;
            } else {
                var targetItemIndex = newItems.findIndex(x => { return x == action.selectRow });
                newItems[targetItemIndex].isSelected = !newItems[targetItemIndex].isSelected ? true : false;
            }
            return {
                ...state,
                items: newItems,
