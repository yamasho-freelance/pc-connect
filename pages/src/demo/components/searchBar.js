...
const styles = theme => ({
    ...
    downloadButton: {
        backgroundColor: "#6AC1B7",
        color: "white",
        "&:hover": {
            backgroundColor: "#50918A"
        }
    },
    bootstrapInput: {
                            ...
                            <Grid style={style} spacing={16} className={isSticky ? classes.searchBarSticky : classes.searchBar} container alignItems="center">
                                ...
                                <Grid item>
                                    ...
                                    >
                                        ...
                                        <List subheader={<ListSubheader style={{ backgroundColor: "lightgray" }}><Checkbox inputRef={this.checkboxRef} onChange={e => this.handleChangeAllConditionUser(e)}></Checkbox>ユーザーの選択</ListSubheader>}>
                                ...
                                <Grid item>
                                    <Button variant="contained" className={classes.downloadButton} onClick={e => this.downloadClick()} disabled={disableDownload} aria-label="Delete">
